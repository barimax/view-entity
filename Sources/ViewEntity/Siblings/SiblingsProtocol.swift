...
protocol NonSelfSiblingProtocol: CommonSiblingProtocol {
    static var pivotSchemas: [String: String] { get }
    static var siblingsParents: [String: String] { get }
}
protocol SiblingsProtocol: NonSelfSiblingProtocol  {
...
extension EntityModelProtocol where Self: NonSelfSiblingProtocol {
    static var parentFiledsKeys: [String : String] {
        Self.siblingsParents
    }
}
extension EntityModelProtocol where Self: SiblingsProtocol {
